...
dkms_install: dkms_modules_install depmod_conf_install udev_rules_install xorg_conf_install tools_install

dkms_uninstall: tools_uninstall xorg_conf_uninstall udev_rules_uninstall depmod_conf_uninstall dkms_modules_uninstall
