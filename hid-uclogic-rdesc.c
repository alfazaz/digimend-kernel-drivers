...
const size_t uclogic_rdesc_xppen_a156p_frame_size =
 ...
 /* Report descriptor template for XP-Pen Artist 12 Pro pen */
const __u8 uclogic_rdesc_xppen_a12p_pen_arr[] = {
	0x05, 0x0D,         /*  Usage Page (Digitizer),                 */
	0x09, 0x02,         /*  Usage (Pen),                            */
	0xA1, 0x01,         /*  Collection (Application),               */
	0x85, 0x02,         /*      Report ID (2),                      */
...
const size_t uclogic_rdesc_xppen_a12p_pen_size =
			sizeof(uclogic_rdesc_xppen_a12p_pen_arr);

/* Report descriptor template for XP-Pen Artist 12 Pro frame */
const __u8 uclogic_rdesc_xppen_a12p_frame_arr[] = {
	0x05, 0x01,         /*  Usage Page (Desktop),               */
	0x09, 0x07,         /*  Usage (Keypad),                     */
	0xA1, 0x01,         /*  Collection (Application),           */
	0x85, UCLOGIC_RDESC_V1_FRAME_ID,
...
const size_t uclogic_rdesc_xppen_a12p_frame_size =
			sizeof(uclogic_rdesc_xppen_a12p_frame_arr);
